...
// 手动展开图像采集日志函数 0-49
VISION_SPDLOG_IMAGE_LOG_FUNC(0)
VISION_SPDLOG_IMAGE_LOG_FUNC(1)
VISION_SPDLOG_IMAGE_LOG_FUNC(2)
VISION_SPDLOG_IMAGE_LOG_FUNC(3)
VISION_SPDLOG_IMAGE_LOG_FUNC(4)
VISION_SPDLOG_IMAGE_LOG_FUNC(5)
VISION_SPDLOG_IMAGE_LOG_FUNC(6)
VISION_SPDLOG_IMAGE_LOG_FUNC(7)
VISION_SPDLOG_IMAGE_LOG_FUNC(8)
VISION_SPDLOG_IMAGE_LOG_FUNC(9)
VISION_SPDLOG_IMAGE_LOG_FUNC(10)
VISION_SPDLOG_IMAGE_LOG_FUNC(11)
VISION_SPDLOG_IMAGE_LOG_FUNC(12)
VISION_SPDLOG_IMAGE_LOG_FUNC(13)
VISION_SPDLOG_IMAGE_LOG_FUNC(14)
VISION_SPDLOG_IMAGE_LOG_FUNC(15)
VISION_SPDLOG_IMAGE_LOG_FUNC(16)
VISION_SPDLOG_IMAGE_LOG_FUNC(17)
VISION_SPDLOG_IMAGE_LOG_FUNC(18)
VISION_SPDLOG_IMAGE_LOG_FUNC(19)
VISION_SPDLOG_IMAGE_LOG_FUNC(20)
VISION_SPDLOG_IMAGE_LOG_FUNC(21)
VISION_SPDLOG_IMAGE_LOG_FUNC(22)
VISION_SPDLOG_IMAGE_LOG_FUNC(23)
VISION_SPDLOG_IMAGE_LOG_FUNC(24)
VISION_SPDLOG_IMAGE_LOG_FUNC(25)
VISION_SPDLOG_IMAGE_LOG_FUNC(26)
VISION_SPDLOG_IMAGE_LOG_FUNC(27)
VISION_SPDLOG_IMAGE_LOG_FUNC(28)
VISION_SPDLOG_IMAGE_LOG_FUNC(29)
VISION_SPDLOG_IMAGE_LOG_FUNC(30)
VISION_SPDLOG_IMAGE_LOG_FUNC(31)
VISION_SPDLOG_IMAGE_LOG_FUNC(32)
VISION_SPDLOG_IMAGE_LOG_FUNC(33)
VISION_SPDLOG_IMAGE_LOG_FUNC(34)
VISION_SPDLOG_IMAGE_LOG_FUNC(35)
VISION_SPDLOG_IMAGE_LOG_FUNC(36)
VISION_SPDLOG_IMAGE_LOG_FUNC(37)
VISION_SPDLOG_IMAGE_LOG_FUNC(38)
VISION_SPDLOG_IMAGE_LOG_FUNC(39)
VISION_SPDLOG_IMAGE_LOG_FUNC(40)
VISION_SPDLOG_IMAGE_LOG_FUNC(41)
VISION_SPDLOG_IMAGE_LOG_FUNC(42)
VISION_SPDLOG_IMAGE_LOG_FUNC(43)
VISION_SPDLOG_IMAGE_LOG_FUNC(44)
VISION_SPDLOG_IMAGE_LOG_FUNC(45)
VISION_SPDLOG_IMAGE_LOG_FUNC(46)
VISION_SPDLOG_IMAGE_LOG_FUNC(47)
VISION_SPDLOG_IMAGE_LOG_FUNC(48)
VISION_SPDLOG_IMAGE_LOG_FUNC(49)
...
class VisionSpdlogAsyncFixture : public benchmark::Fixture {
public:
    VisionSpdlogAsyncFixture() {
        LoadTestLogs();
    }
        ...
        std::call_once(g_spdlog_vision_init_flag, []() {
            try {
                ...
                auto logger = spdlog::basic_logger_mt<spdlog::async_factory>(
                    "vision_logger", "logs/vision_spdlog_async.log", true);
                logger->set_level(spdlog::level::debug);
                logger->set_pattern("[%Y-%m-%d %H:%M:%S.%e] [%t] [%^%l%$] %v");

                spdlog::set_default_logger(logger);
                spdlog::info("Vision spdlog async benchmark initialized");
            }
...
// 场景1: 图像采集日志 - 高频
VISION_BENCHMARK_IMAGE(VisionSpdlogAsyncFixture, image_acquisition)

// 场景2: 检测结果日志 - 实时
VISION_BENCHMARK_DETECTION(VisionSpdlogAsyncFixture, detection_result)

// 场景3: 设备状态日志 - 周期性上报
VISION_BENCHMARK_DEVICE(VisionSpdlogAsyncFixture, device_status)

// 场景4: 异常告警日志 - 偶发
VISION_BENCHMARK_ALARM(VisionSpdlogAsyncFixture, alarm_log)

// 场景5: 生产统计日志 - 周期性汇总
VISION_BENCHMARK_PRODUCTION(VisionSpdlogAsyncFixture, production_stats)
